## V&V Game - Sistema Ultra-Limpo
## Logs mínimos, apenas o essencial

extends Node2D

# Preloads das classes ultra-limpas
const PlayerInstance = preload("res://scripts/systems/player_instance_clean.gd")
const GameServer = preload("res://scripts/systems/game_server_clean.gd")
const SharedGameState = preload("res://scripts/systems/shared_game_state_clean.gd")
...
const FogOfWar = preload("res://scripts/fog_of_war_clean.gd")
...
## Callbacks do servidor (SEM LOGS)
