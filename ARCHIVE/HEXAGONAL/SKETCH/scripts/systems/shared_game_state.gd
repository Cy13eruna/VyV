## SharedGameState - Estado Compartilhado do Jogo
## Mantém elementos que são compartilhados entre todos os jogadores
## Tabuleiro, regras globais e sistemas centralizados

class_name SharedGameState
extends RefCounted
...
func setup(grid, mapper, node):
	...
	print("SharedGameState: Componentes configurados")
